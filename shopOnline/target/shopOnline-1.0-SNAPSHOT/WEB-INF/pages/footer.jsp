<%-- 
    Document   : footer
    Created on : Nov 20, 2017, 10:29:40 AM
    Author     : NhutKha
--%>
            ...
            <div class="footer-top">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                                ...
                                <div class="video-gallery text-center">
                                    <a href="#">
                                        <div class="iframe-img">
                                            <img src="<c:url value="/resources/images/home/iframe1.png" />" alt="" />
                                        </div>
                            ...
                            <div class="col-sm-3">
                                <div class="video-gallery text-center">
                                    <a href="#">
                                        <div class="iframe-img">
                                            <img src="<c:url value="/resources/images/home/iframe2.png" />" alt="" />
                                        </div>
                                        <div class="overlay-icon">
                                            <i class="fa fa-play-circle-o"></i>
                                        </div>
                            ...
                            <div class="col-sm-3">
                                <div class="video-gallery text-center">
                                    <a href="#">
                                        <div class="iframe-img">
                                            <img src="<c:url value="/resources/images/home/iframe3.png" />" alt="" />
                                        </div>
                                        <div class="overlay-icon">
                                            <i class="fa fa-play-circle-o"></i>
                                        </div>
                            ...
                            <div class="col-sm-3">
                                <div class="video-gallery text-center">
                                    <a href="#">
                                        <div class="iframe-img">
                                            <img src="<c:url value="/resources/images/home/iframe4.png" />"alt="" />
                                        </div>
                                        <div class="overlay-icon">
                                            <i class="fa fa-play-circle-o"></i>
                                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="address">
                                <img src="<c:url value="/resources/images/home/map.png" />" alt="" />
