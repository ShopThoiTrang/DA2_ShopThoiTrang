<%-- 
    Document   : about
    Created on : Nov 20, 2017, 12:10:47 PM
    Author     : NhutKha
--%>
...
<body>
 ...
 <header class="main-header">
   	<div class="row">
      		...
      		<a href="${pageContext.request.contextPath}/home/index"><img src="<c:url value="/resources/images/home/logo.png" />" width="400x"   alt="" /></a>
		   ...
		   <div class="main-content">
		   	<div class="row">
		   		<div class="col-twelve">
			  			...
			  			<h1 class="kern-this">E-SHOPPER.</h1>
			  			<p>
						 Shop chuyên bán quần áo..rẻ nhất sài thành, mong bà con cô bác ủng hộ :))
			  			</p>
